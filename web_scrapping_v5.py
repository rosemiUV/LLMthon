...
async def procesar_web(page, url):
    """
    Navega y extrae info estructurada (Status, Junk, Texto, URL Evidencia).
    ...
    resultado = {
        ...
        "text_content": "",  
        "error_msg": None,
        "url_evidencia": url # NUEVO: Por defecto, la URL donde está la info es la Home
    }
        ...
        if url_secundaria:
            try:
                ...
                if len(texto_secundario) > 100:
                    ...
                    # NUEVO: Si hemos entrado aquí y hay texto, ESTA es la url importante
                    resultado["url_evidencia"] = page.url 
                    print(f"   -> [INFO] URL Evidencia actualizada a: {page.url}")
                else:
        ...
        for index, row in df.iterrows():
            ...
            if not url_final or pd.isna(raw_url):
                ...
                datos = {
                    ...
                    "is_junk": "False", 
                    "text_content": "",
                    "url_evidencia": None, # NUEVO
                    "error_msg": "URL vacía en Excel"
                }
            ...
            datos_finales = {
                ...
                "url_evidencia": resultado_web["url_evidencia"], # NUEVO: Guardamos la URL final
